package com.kotlin.loginapp.login.components
...
import com.kotlin.loginapp.util.TestTags
...
fun PasswordInputField(
    ...
    OutlinedTextField(
        ...
        trailingIcon = {
            ...
            {
                Icon(
                    imageVector = if (authState.togglePasswordVisibility) Icons.Default.Face else Icons.Default.Lock,
